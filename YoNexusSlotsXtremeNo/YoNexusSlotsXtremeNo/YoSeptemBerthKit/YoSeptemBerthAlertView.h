...
#import "YoSeptemBerthTextField.h"
...
@interface YoSeptemBerthAlertView : UIView
...
- (void)alertView:(YoSeptemBerthAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex;
...
- (void)willPresentAlertView:(YoSeptemBerthAlertView *)alertView;  // before animation and showing view
- (void)didPresentAlertView:(YoSeptemBerthAlertView *)alertView;  // after animation

- (void)alertView:(YoSeptemBerthAlertView *)alertView willDismissWithButtonIndex:(NSInteger)buttonIndex; // before animation and hiding view
- (void)alertView:(YoSeptemBerthAlertView *)alertView didDismissWithButtonIndex:(NSInteger)buttonIndex;  // after animation
