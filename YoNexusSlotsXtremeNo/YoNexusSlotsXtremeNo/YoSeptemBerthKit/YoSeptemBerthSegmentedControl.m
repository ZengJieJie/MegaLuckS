...
#import "YoSeptemBerthSegmentedControl.h"
#import "UIImage+FlatUI.h"
#import "UIColor+FlatUI.h"
#import "UIFont+FlatUI.h"

@implementation YoSeptemBerthSegmentedControl

+ (void)initialize {
    if (self == [YoSeptemBerthSegmentedControl class]) {
        YoSeptemBerthSegmentedControl *appearance = [self appearance];
